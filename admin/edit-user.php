            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "UPDATE user SET username = '$username', fullname = '$fullname', password = '$unhashed_password', email = '$email', phone = '$phone', address = '$address', role = '$role' WHERE id = $id";
                        $result = mysqli_query($conn, $sql);
                    ...
                    ?>
                     <form method="post" enctype="multipart/form-data">
                        ...
                        <input type="password" name="password" value="<?php
                            ...
                            $unhashed_password = password_verify($password, PASSWORD_DEFAULT);
                            echo $unhashed_password;
