			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i>+94 938976425</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> ttuantrung@protonmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> 745/2 HCM</a></li>
					</ul>
							...
							<div class="header-ctn">
								...
								?>
									...
									<div class="cart-btns">
										...
										<a href="cart2.php">Checkout <i class="fa fa-arrow-circle-right"></i></a>
									</div>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="store.php">Deal Hot</a></li>
						<li><a href="store.php">Danh mục sản phẩm</a></li>
						<li><a href="store.php?category=Laptop&keyword=">Laptops</a></li>
						<li><a href="store.php?category=LinhKien&keyword=">Linh kiện máy tính</a></li>
						<li><a href="store.php?category=Phukien&keyword=">Phụ kiện</a></li>
