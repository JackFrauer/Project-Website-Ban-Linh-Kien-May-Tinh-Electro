			...
			<div class="row">
				...
				<div class="col-md-5 col-md-push-2">
					<div id="product-main-img">
						...
						// Split the path by comma to get an array of paths
						$image_array = explode(",", $image_path);
						// Loop through the array and display each image in a product-preview div
				...
				?>
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price"><?php echo number_format($row['price']); ?>đ</h3>
